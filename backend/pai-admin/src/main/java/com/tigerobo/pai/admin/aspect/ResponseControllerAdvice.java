...
@Slf4j
@RestControllerAdvice(basePackages = {"com.tigerobo.pai.admin.controller"}) // 注意哦，这里要加上需要扫描的包
...
//        log.info("resp:advice:name:{}",simpleName);
        ...
        try {
            ...
            final ResponseIgnore annotation = method.getAnnotation(ResponseIgnore.class);
            if (annotation!=null){
                return false;
            }
