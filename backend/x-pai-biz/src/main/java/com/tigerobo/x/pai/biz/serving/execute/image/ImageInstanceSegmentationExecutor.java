...
@Slf4j
@Data
public class ImageInstanceSegmentationExecutor extends UriApiExecutor {

    Style style = Style.IMAGE_INSTANCE_SEGMENTATION;

    public ImageInstanceSegmentationExecutor(ApiDto api) {
        super(api);
    }
